...
export async function upsertPermit(permit: ProcessedPermit): Promise<void> {
  ...
  await db.execute({
    ...
    args: [
      permit.id ?? null,
      permit.permitNum ?? null,
      permit.revisionNum ?? null,
      permit.permitType ?? null,
      permit.structureType ?? null,
      permit.work ?? null,
      permit.address ?? null,
      permit.postalCode ?? null,
      permit.geoId ?? null,
      ...
      permit.currentUse ?? null,
      permit.proposedUse ?? null,
      permit.dwellingUnitsCreated ?? 0,
      permit.dwellingUnitsLost ?? 0,
      permit.netDwellingUnits ?? 0,
      permit.grossFloorArea ?? null,
      permit.latitude ?? null,
      permit.longitude ?? null,
      permit.neighbourhood ?? null,
      permit.ward ?? null,
      permit.processingDays ?? null,
      permit.completionDays ?? null,
      permit.totalDays ?? null,
      permit.category ?? null,
    ],
  });
}
